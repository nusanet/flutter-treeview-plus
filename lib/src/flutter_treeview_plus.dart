...
class FlutterTreeviewPlus extends StatefulWidget {
  ...
  @override
  State<FlutterTreeviewPlus> createState() => _FlutterTreeviewPlusState();
}

class _FlutterTreeviewPlusState extends State<FlutterTreeviewPlus> {
  final treeviewBloc = TreeviewBloc();
